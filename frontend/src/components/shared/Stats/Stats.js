...
function Stats({ user }) {
  ...
  return (
    <div className="container">
      ...
      {!hasAnyData && !loading && (
        <div className="stats-welcome" role="region" aria-label="Getting started">
          <div className="stats-welcome-icon" aria-hidden="true">⛰</div>
          <h2>Welcome to FieldTrip, {user.name.split(" ")[0]}!</h2>
          <p>
            Your stats will grow as you explore. Start by discovering activities
            others have posted, or share something cool you&apos;ve found.
          </p>
          <div className="stats-welcome-actions">
