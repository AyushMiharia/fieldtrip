...
function MyTrips({ user }) {
  ...
  return (
    <div className="container">
      ...
      <div className="mytrips-tabs" role="tablist" aria-label="Trip status filter">
      ...
      {/* Trips I Organized */}
      <section className="mytrips-section" aria-label="Trips I organized">
        <h2>
          Trips I Organized
      ...
      {/* Trips I Joined */}
      <section className="mytrips-section" aria-label="Trips I joined">
        <h2>
          Trips I Joined
