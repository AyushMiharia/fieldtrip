...
function ActivityDetail({ user }) {
  ...
  return (
    <div className="container">
      <div className="detail-page" role="region" aria-label="Activity details">
        ...
        {/* Trips Section */}
        <section className="detail-section" aria-label="Scheduled trips">
        ...
        {activity.description && (
          <section className="detail-section detail-about" aria-label="About this activity">
