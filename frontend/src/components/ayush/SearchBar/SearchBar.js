...
function SearchBar({ filters, setFilters, onSearch }) {
  ...
  return (
    <form className="search-bar" onSubmit={handleSubmit} role="search" aria-label="Search activities">
      ...
      <div className="search-filters-label" aria-hidden="true">
        <span className="filters-label-text">Filters</span>
        <span className="filters-label-line"></span>
      </div>
